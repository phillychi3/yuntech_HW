...
api_url = "Your Line Notify Lambda Url"
...
def lambda_handler(event, context):
    ...
    try:
        ...
        log_event(
            ...
            {
                "status_code": lineresponse.status,
                "response_length": len(lineresponse.data),
            },
        )
        ...
        log_event(
            "REQUEST_COMPLETED",
            {"execution_time_seconds": execution_time, "status_code": 200},
        )
        return {
            "statusCode": 200,
            "headers": {
