...
tt1 = Person("ttttt")
tt1 = Politician(tt1, "red")
tt2 = Person("ggggg")
tt2 = Politician(tt2, "blue")
tt3 = Person("hhhhh")
tt3 = Politician(tt3, "blue")
tt4 = Person("jjjjj")
tt4 = Politician(tt4)

print(tt1.might_agree(tt3))
print(tt2.might_agree(tt3))
print(tt3.might_agree(tt4))
